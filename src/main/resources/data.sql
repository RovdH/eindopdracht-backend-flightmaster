...
VALUES
    ...
    ('user2@flightmaster.nl', '$2a$12$ZvstzDXUyz0yEMNoMO/.TejYRKp19QVAxISy.wgGoJ4n/5EquC0.q', 'USER'),
    ('pilot@flightmaster.nl', '$2a$12$ZvstzDXUyz0yEMNoMO/.TejYRKp19QVAxISy.wgGoJ4n/5EquC0.q', 'PILOT')
ON CONFLICT DO NOTHING;

INSERT INTO helicopters ( call_sign, type, capacity, fuel_capacity, fuel_usage, available)
VALUES
    ('PH-HLC', 'Robinson R44', 3, 190, 60, true),
    ('PH-HLX', 'Airbus H125', 4, 250, 75, true);

INSERT INTO events (location, event_date, start_time, end_time, flight_time)
VALUES
    ('Lelystad airport airfair', DATE '2025-05-10', TIME '12:00', '17:00', 7),
    ('Heliport flight experience Rotterdam', DATE '2025-07-01', TIME '14:00', TIME '18:00',10);
...
VALUES
    ...
    ('Mark', 'Rensen', 'm.rensen@hotmail.com',79, 3, 1);